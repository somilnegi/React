  ...
  return (
    <div className="w-full h-screen" style={{backgroundColor: color}}>
      <div className="fixed flex flex-wrap justify-center bottom-20 inset-x-0" >
        <div className="flex flex-wrap justify-between w-300 gap-3 shadow-xl bg-white px-3 py-2 rounded-2xl">
          ...
          <button onClick={() => setColor("yellow")} className="outline-none px-4  rounded-2xl text-black shadow-lg" style={{backgroundColor: "yellow"}}>Yellow</button>
          ...
          <button onClick={() => setColor("brown")} className="outline-none px-4 py-1 rounded-2xl text-white shadow-lg" style={{backgroundColor: "brown"}}>Brown</button>
        </div>
      </div>
    </div>
  )
